---
title: "Why You're Not Getting Stronger (And Why Changing Your Program Won't Fix It)"
date: "2026-03-30"
category: "Psychology"
author: "Leo Gayrard"
...
faqs:
  - question: "Why do I keep plateauing despite following a good program?"
    answer: "Most plateaus in experienced lifters are not programming problems. They are consistency and psychological problems — switching programs too early, avoiding the heaviest sessions, or never fully committing to the process. A good program only works if you let it work."
  - question: "How long should I run a program before changing it?"
    answer: "Most intermediate and advanced lifters change programs far too early. A minimum of 12 weeks on a well-structured program is usually necessary to see its full effect. The discomfort you feel around week 4 or 5 is not a sign to change — it is usually a sign that the program is working."
  - question: "Can psychological factors actually limit strength gains?"
...
You load the bar. Same weight as last month. Same weight as the month before that.

You've read the articles. You've tried the deload. You switched programs twice in the last six months — from 5/3/1 to a Russian template to something you found on a forum that looked promising. You train four days a week, you eat enough, you sleep reasonably well.

And still. The same weight.

The standard advice at this point is to change something — your programming, your volume, your exercise selection. Add more sets. Reduce the frequency. Introduce accommodating resistance. Try a longer peaking block.

This advice is not wrong, exactly. But for a significant number of lifters, it misses the actual problem entirely.

## The Program is Not the Problem

Here is something that rarely gets said plainly: most intermediate and advanced lifters do not have a programming problem. They have a consistency problem — and consistency, in this context, does not mean showing up to the gym. It means something harder than that.

It means staying on a program when it stops feeling exciting. Running the same movements for the twelfth week in a row when every instinct tells you to switch things up. Walking into a session knowing the weights are going to be brutal and doing it anyway, without finding a reason to take it easier today.
...
This is the part that most training content skips over.

Changing programs every six weeks feels like optimization. It looks like you're being smart, responding to your body, staying up to date with the science. And sometimes it is those things. But often — more often than most lifters would like to admit — it is something else.

It is the moment a program gets genuinely hard, where the weights are heavy enough that failure is a real possibility, where each session asks something you are not sure you can give. And right at that moment, something more interesting appears. A new template. A different approach. A coach on YouTube with a compelling argument for why you should be training completely differently.
