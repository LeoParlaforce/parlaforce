---
title: "You Don't Have Tendinitis. You Have Cortisol."
slug: "tendinitis-cortisol-chronic-pain-psyche"
description: "Tendinitis, runner's knee, chronic inflammation: most athletes treat them as mechanical issues. They're not. The first event in your body is always cortisol. Here's why."
summary: "Tendinitis, runner's knee, chronic inflammation: most athletes treat them as mechanical issues. They're not. The first event in your body is always cortisol. Here's why."
canonical: "https://parlaforce.com/articles/tendinitis-cortisol-chronic-pain-psyche"
date: "2026-05-18"
author: "Léo Gayrard"
category: "Recovery"
image: "/tendinitis-cortisol.jpg"
imageCredit: "Photo by [Marek Studzinski](https://unsplash.com/fr/@jccards) on Unsplash"
tags: ["cortisol", "tendinitis", "chronic pain", "runner's knee", "inflammation", "recovery", "stress", "psychosomatic", "placebo effect"]
faqs:
  - question: "Is my tendinitis really caused by cortisol and not by my movement pattern?"
    answer: "Both. The way you move matters, but so does the state of the system that recovers from movement. Two athletes can execute the same movement, one with perfect form and one with mild dysfunction, and the one with the higher chronic cortisol will be the one who breaks down. The mechanical question and the systemic question are not separate — they interact. The error is thinking it has to be one or the other."
  - question: "How does the placebo effect actually work in chronic pain?"
    answer: "The placebo effect is not an exception that happens occasionally. It's the rule. Your psyche acts on your body continuously, in every direction. When you believe a new insole will fix your knee, the belief alone reduces your stress response, lowers cortisol, and accelerates recovery — for two weeks. Then your psyche catches up to the fact that nothing has fundamentally changed, and the pain returns. The placebo wasn't a trick of the insole. The insole was the trick of the placebo."
  - question: "Why do I keep getting the same injury even after fixing my form?"
    answer: "Because the injury was never primarily about your form. The body picks the weakest link in a stressed system. You fix the link, the system stays stressed, another link breaks. This is why people who collect specialists never get better — each specialist fixes one mechanical detail while the underlying state of the system remains untouched. Until the cortisol comes down, the body will keep producing symptoms."
  - question: "Is this just psychosomatic? Am I making my pain up?"
    answer: "No. The pain is completely real. The tissue inflammation is real. The tendon damage is real. What's not real is the idea that these things happen independently of your psyche. Your nervous system, your hormones, and your tissues are one continuous system. Calling it psychosomatic is misleading because it suggests there's a 'somatic' part separate from a 'psycho' part. There isn't. The whole thing is one system, and you are the one driving it."
  - question: "What does the symptom actually mean? Does my body try to tell me something?"
    answer: "Yes, but not in a mystical way. The symptom is what happens when your psyche cannot say something through speech. It comes back through the body. What you refuse to look at returns as pain, injury, chronic tension. The point is not to decode it like a riddle, but to recognize that the symptom has a function for you — it lets you avoid something you don't want to face. Therapy works precisely on that point: not on the tendon, on what the tendon is letting you avoid."
  - question: "Should I stop seeing my physiotherapist and see a therapist instead?"
    answer: "No, both. The body work matters. But if you've been to five physiotherapists, three orthopedists, two podiatrists, and you're still in pain, the problem is not on the mechanical layer. Adding a sixth specialist will not solve it. At some point you have to ask the question your specialists won't ask: what does this pain let me avoid in my life?"
---
...
Stop. **You don't have tendinitis. You don't have runner's knee. You don't have chronic inflammation. What you have is <span style="color:#ef4444">cortisol</span>.**
...
But there is something worse than being sold the wrong thing. The specialist's entire logic is organized around one objective: **<span style="color:#ef4444">erase</span> the symptom. <span style="color:#ef4444">Silence it.</span> Close the case.** He is not interested in what the symptom is saying. He is interested in making it stop saying it. Every diagnosis is a closing move. Every protocol is an instruction to the body to stop producing the signal.
...
**The question your symptom is asking is <span style="color:#ef4444">more interesting</span> than any answer a specialist can give you.** A good answer closes the question. A real question opens something. The specialist, by profession, is in the business of closing. That is exactly why he cannot help you here.
...
If recovery > damage, you adapt. You get stronger. Tissues remodel.
If damage > recovery, you accumulate dysfunction. Tissues degrade. Eventually, pain.

[CTA-ELITE]

Cortisol is the master variable that determines which side of this equation wins. Form matters. Volume matters. Sleep matters. Nutrition matters. But cortisol modulates how all of these convert into outcomes. **High cortisol turns good training into damage. Low cortisol turns mediocre training into adaptation.**

You can chase form details for years. You can buy expensive insoles. You can hire the best coaches. If your cortisol stays high, none of it will hold.
...
This is what symptoms are. They are not random malfunctions. They are not bad luck. **They are the return, <span style="color:#ef4444">through the flesh</span>, of what speech could not say.**
...
You can see something is happening that your protocols cannot reach. You can sense that the body work is necessary but not sufficient. You may even sense that some of your clients are getting worse despite your best work, because what they need is being routed back to them through the only channel they accept — the body — when it actually needs another channel to be opened.

This is exactly the situation where supervision with a psychoanalyst can transform your practice. Not by turning you into a therapist. By giving you the conceptual tools to recognize what's happening in front of you, to position yourself appropriately, and to know when to refer.
