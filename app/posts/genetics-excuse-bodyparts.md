---
title: "The Genetics Excuse: Why Your Bodyparts Aren't Doomed"
...
faqs:
  - question: "Are some people genetically better at building muscle?"
    answer: "Yes, but it's a matter of degree, not category. Some people gain faster, recover faster, store fat more easily. Nobody is genetically locked out of building any given muscle. The 'I can't because genetics' framing collapses a continuous reality into a binary one that doesn't exist."
  - question: "What about long femurs and the squat?"
    answer: "Long femurs change the leverages of a back squat. They don't change whether you can build quads. If your quads are weak, they fold under load — your torso shifts forward, the posterior chain takes over, and you keep telling yourself the squat doesn't work for you. The honest answer is that your quads aren't strong enough yet to hold the position. Build them where they cannot escape, and the squat eventually works as well."
  - question: "Isn't 'genetics' the reason some people gain muscle so much faster?"
    answer: "Speed of gain is a different question from ultimate capacity. Two people can end up at the same place via different paths, even if one took longer. The fastest gainers often crash earliest. The training that produces lasting results is the one you commit to and stay with for years, regardless of how it feels along the way."
  - question: "What if I keep changing exercises and still don't see results?"
    answer: "Then the changing itself is the problem. The constant switching feels like effort but it's the opposite — it's how you avoid letting any exercise demand something from you. New exercise every few weeks, new theory after every video. Each switch resets the clock. Pick something serious and stay with it long enough for it to demand real work."
