---
title: "Why You Bomb Out in Competition But Hit the Lift in Training"
date: "2026-04-09"
category: "Psychology"
author: "Leo Gayrard"
summary: "The standard answers — nerves, pressure, your 'type' as an athlete — are wrong. Not wrong as in imprecise. Wrong as in designed to avoid the actual question. Here is what is really happening when the platform reveals something training never does."
...
faqs:
  ...
  - question: "Is it true that some athletes are just 'training athletes' who peak in the gym?"
    answer: "This is one of the most common ways coaches and sport psychologists avoid the real question. Calling it a 'type' transforms a symptom into a characteristic — something innate, permanent, untouchable. The whole point of working with performance psychology is to work on symptoms, not to explain why they cannot be touched."
  - question: "What does adrenaline actually do to performance?"
    answer: "Adrenaline is neutral. It produces sensations. What the athlete does with those sensations — whether they are interpreted as a signal of danger or as a signal that the body is ready — depends on what is inscribed in them through their history, their relationship to competition, and their motivations, including unconscious ones."
  - question: "What is the role of the unconscious in athletic performance?"
    answer: "The unconscious is the set of motivations, histories, and meanings that operate in us without our full awareness. In competition, when the pressure is real, these come to the surface. An athlete who has not worked on this dimension of their performance is working with only part of what actually determines the outcome."
  - question: "Can performance psychology actually change how an athlete performs under pressure?"
    answer: "Yes. Not through techniques, typologies, or diagnoses. The work is on the athlete's relationship to what competition means for them personally, what the stakes represent, what they are actually there to prove or find out. This is not magic, and it is not pure science. It is a third register — what Lacan called the symbolic — and it is where the real work of performance psychology takes place."
  - question: "Should an athlete perform better in competition than in training?"
    answer: "Yes. Everything in training — the programming, the periodization, the peaking cycle — is designed to produce a maximum performance at a specific moment. If that is not happening, something is getting in the way. The job of performance psychology is not to explain what that something is and declare it fixed. It is to work on it."
---
